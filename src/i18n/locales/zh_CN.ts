...
const zh_CN: TranslationMap = {
  ...
  "- Pairing/allowlists + mention gating.": "- 启用配对/白名单 + 提及门控。",
  "- Run: {command}": "- 运行：{command}",
  "- Sandbox + least-privilege tools.": "- 使用沙箱 + 最小权限工具。",
  ...
  "A URL will be shown for you to open in your LOCAL browser.":
    "A URL will be shown for you to open in your LOCAL browser.",
  "A bad prompt can trick it into doing unsafe things.": "恶意提示可能会诱导它执行不安全的操作。",
  ...
  "Agent workspace directory (default: ~/.openclaw/workspace)":
    'Agent workspace directory (default: ~/.openclaw/workspace)": ~/.openclaw/workspace)',
  ...
  "Alternative: set BRAVE_API_KEY in the Gateway environment (no config changes).":
    'Alternative: set BRAVE_API_KEY in the Gateway environment (no config changes).": set BRAVE_API_KEY in the Gateway environment (no config changes).',
  Anthropic: "Anthropic",
  ...
  "Auth profile id (non-interactive; default: <provider>:manual)":
    'Auth profile id (non-interactive; default: <provider>:manual)": <provider>:manual)',
  ...
  "Capture a photo from a node camera (prints MEDIA:<path>)":
    'Capture a photo from a node camera (prints MEDIA:<path>)": <path>)',
  "Capture a screenshot (MEDIA:<path>)": "捕获截图 (MEDIA:<path>)",
  "Capture a short screen recording from a node (prints MEDIA:<path>)":
    'Capture a short screen recording from a node (prints MEDIA:<path>)": <path>)',
  "Capture a short video clip from a node camera (prints MEDIA:<path>)":
    'Capture a short video clip from a node camera (prints MEDIA:<path>)": <path>)',
  "Capture a snapshot (default: ai; aria is the accessibility tree)":
    'Capture a snapshot (default: ai; aria is the accessibility tree)": ai; aria is the accessibility tree)',
  ...
  "Channel target for permission audit (Discord channel:<id>)":
    'Channel target for permission audit (Discord channel:<id>)": <id>)',
  ...
  "Choose exactly one payload: --system-event or --message":
    'Choose exactly one payload: --system-event or --message": --system-event or --message',
  "Choose exactly one schedule: --at, --every, or --cron":
    'Choose exactly one schedule: --at, --every, or --cron": --at, --every, or --cron',
  "Christmas: Ho ho ho—Santa's little claw-sistant is here to ship joy, roll back chaos, and stash the keys safely.":
    "Christmas: Ho ho ho—Santa's little claw-sistant is here to ship joy, roll back chaos, and stash the keys safely.\": Ho ho ho—Santa's little claw-sistant is here to ship joy, roll back chaos, and stash the keys safely.",
  ...
  "Chutes docs: https://chutes.ai/docs/sign-in-with-chutes/overview":
    'Chutes docs: https://chutes.ai/docs/sign-in-with-chutes/overview": https://chutes.ai/docs/sign-in-with-chutes/overview',
  ...
  "Configure DM access policies now? (default: pairing)":
    'Configure DM access policies now? (default: pairing)": pairing)',
  ...
  "DM security: default is pairing; unknown DMs get a pairing code.":
    'DM security: default is pairing; unknown DMs get a pairing code.": default is pairing; unknown DMs get a pairing code.',
  "DNS helpers": "DNS 助手",
  ...
  "Default: pairing (unknown DMs get a pairing code).":
    'Default: pairing (unknown DMs get a pairing code).": pairing (unknown DMs get a pairing code).',
  ...
  "Diwali: Let the logs sparkle and the bugs flee—today we light up the terminal and ship with pride.":
    'Diwali: Let the logs sparkle and the bugs flee—today we light up the terminal and ship with pride.": Let the logs sparkle and the bugs flee—today we light up the terminal and ship with pride.',
  ...
  "Docs: https://docs.openclaw.ai/concepts/multi-agent":
    'Docs: https://docs.openclaw.ai/concepts/multi-agent": https://docs.openclaw.ai/concepts/multi-agent',
  ...
  "Easter: I found your missing environment variable—consider it a tiny CLI egg hunt with fewer jellybeans.":
    'Easter: I found your missing environment variable—consider it a tiny CLI egg hunt with fewer jellybeans.": I found your missing environment variable—consider it a tiny CLI egg hunt with fewer jellybeans.',
  ...
  "Eid al-Fitr: Celebration mode: queues cleared, tasks completed, and good vibes committed to main with clean history.":
    'Eid al-Fitr: Celebration mode: queues cleared, tasks completed, and good vibes committed to main with clean history.": Celebration mode: queues cleared, tasks completed, and good vibes committed to main with clean history.',
  ...
  "Example: Save session context to memory when you issue /new.":
    'Example: Save session context to memory when you issue /new.": Save session context to memory when you issue /new.',
  ...
  "Fix: set gateway.remote.url, or set gateway.mode=local.":
    'Fix: set gateway.remote.url, or set gateway.mode=local.": set gateway.remote.url, or set gateway.mode=local.',
  ...
  "Gateway bind: loopback|tailnet|lan|auto|custom":
    'Gateway bind: loopback|tailnet|lan|auto|custom": loopback|tailnet|lan|auto|custom',
  ...
  "Halloween: Spooky season: beware haunted dependencies, cursed caches, and the ghost of node_modules past.":
    'Halloween: Spooky season: beware haunted dependencies, cursed caches, and the ghost of node_modules past.": Spooky season: beware haunted dependencies, cursed caches, and the ghost of node_modules past.',
  "Hanukkah: Eight nights, eight retries, zero shame—may your gateway stay lit and your deployments stay peaceful.":
    'Hanukkah: Eight nights, eight retries, zero shame—may your gateway stay lit and your deployments stay peaceful.": Eight nights, eight retries, zero shame—may your gateway stay lit and your deployments stay peaceful.',
  "Hatch in TUI (recommended)": "在 TUI 中启动 (推荐)",
  ...
  "How long to wait for the download to start (default: 120000)":
    'How long to wait for the download to start (default: 120000)": 120000)',
  ...
  "How long to wait for the next file chooser (default: 120000)":
    'How long to wait for the next file chooser (default: 120000)": 120000)',
  ...
  "I understand this is powerful and inherently risky. Continue?":
    "我理解这是一个功能强大且具有固有风险的工具。是否继续？",
  "I went away and came back smarter. You should try it sometime.":
    "I went away and came back smarter. You should try it sometime.",
  "I'll butter your workflow like a lobster roll: messy, delicious, effective.":
    "I'll butter your workflow like a lobster roll: messy, delicious, effective.\": messy, delicious, effective.",
  ...
  "I'm like tmux: confusing at first, then suddenly you can't live without me.":
    "I'm like tmux: confusing at first, then suddenly you can't live without me.\": confusing at first, then suddenly you can't live without me.",
  ...
  "If you need multiple gateways (e.g., a rescue bot on the same host), isolate ports + config/state (see docs: /gateway#multiple-gateways-same-host).":
    'If you need multiple gateways (e.g., a rescue bot on the same host), isolate ports + config/state (see docs: /gateway#multiple-gateways-same-host).": /gateway#multiple-gateways-same-host).',
  ...
  "Linux installs use a systemd user service by default. Without lingering, systemd stops the user session on logout/idle and kills the Gateway.":
    "Linux 安装默认使用 systemd 用户服务。如果不启用常驻 (lingering)，systemd 会在注销/空闲时停止用户会话并杀死 Gateway。",
  ...
  "Lunar New Year: May your builds be lucky, your branches prosperous, and your merge conflicts chased away with fireworks.":
    'Lunar New Year: May your builds be lucky, your branches prosperous, and your merge conflicts chased away with fireworks.": May your builds be lucky, your branches prosperous, and your merge conflicts chased away with fireworks.',
  ...
  "New Year's Day: New year, new config—same old EADDRINUSE, but this time we resolve it like grown-ups.":
    "New Year's Day: New year, new config—same old EADDRINUSE, but this time we resolve it like grown-ups.\": New year, new config—same old EADDRINUSE, but this time we resolve it like grown-ups.",
  ...
  "Non-interactive scan: pass --yes to apply defaults.":
    'Non-interactive scan: pass --yes to apply defaults.": pass --yes to apply defaults.',
  ...
  "Note: enable discovery.wideArea.enabled in ~/.openclaw/openclaw.json on the gateway and restart the gateway so it writes the DNS-SD zone.":
    'Note: enable discovery.wideArea.enabled in ~/.openclaw/openclaw.json on the gateway and restart the gateway so it writes the DNS-SD zone.": enable discovery.wideArea.enabled in ~/.openclaw/openclaw.json on the gateway and restart the gateway so it writes the DNS-SD zone.',
  ...
  "Onboarding complete. Dashboard opened with your token; keep that tab to control OpenClaw.":
    "Onboarding 完成。仪表板已使用您的 Token 打开；保持该标签页以控制 OpenClaw。",
  "Onboarding complete. Use the tokenized dashboard link above to control OpenClaw.":
    "Onboarding 完成。使用上面的带 Token 仪表板链接来控制 OpenClaw。",
  "Onboarding complete. Web UI seeded in the background; open it anytime with the tokenized link above.":
    "Onboarding 完成。Web 界面已在后台初始化；随时可以使用上面的带 Token 链接打开。",
  "Onboarding mode": "Onboarding 模式",
  ...
  "OpenAI OAuth uses localhost:1455 for the callback.":
    'OpenAI OAuth uses localhost:1455 for the callback.": 1455 for the callback.',
  ...
  "OpenClaw is a hobby project and still in beta. Expect sharp edges.":
    "OpenClaw 是一个个人爱好项目，目前仍处于 Beta 阶段。可能会有一些不完善的地方。",
  ...
  "Re-enable with `cron.enabled: true` (or remove `cron.enabled: false`) and restart the Gateway.":
    'Re-enable with `cron.enabled: true` (or remove `cron.enabled: false`) and restart the Gateway.": true` (or remove `cron.enabled: false`) and restart the Gateway.',
  ...
  "Run a dev Gateway (isolated state/config) on ws://127.0.0.1:19001.":
    'Run a dev Gateway (isolated state/config) on ws://127.0.0.1:19001.": //127.0.0.1:19001.',
  ...
  "SSH target for remote gateway tunnel (user@host or user@host:port)":
    'SSH target for remote gateway tunnel (user@host or user@host:port)": port)',
  "SSH tunnel": "SSH 隧道",
  ...
  "Save path (default: /tmp/openclaw/downloads/...)":
    'Save path (default: /tmp/openclaw/downloads/...)": /tmp/openclaw/downloads/...)',
  ...
  "Shared token required in connect.params.auth.token (default: OPENCLAW_GATEWAY_TOKEN env if set)":
    'Shared token required in connect.params.auth.token (default: OPENCLAW_GATEWAY_TOKEN env if set)": OPENCLAW_GATEWAY_TOKEN env if set)',
  "Shell env": "Shell 环境",
  ...
  "Skipped: working directory has uncommitted changes. Commit or stash them first.":
    'Skipped: working directory has uncommitted changes. Commit or stash them first.": working directory has uncommitted changes. Commit or stash them first.',
  ...
  "Stored in: ~/.openclaw/openclaw.json (gateway.auth.token) or OPENCLAW_GATEWAY_TOKEN.":
    'Stored in: ~/.openclaw/openclaw.json (gateway.auth.token) or OPENCLAW_GATEWAY_TOKEN.": ~/.openclaw/openclaw.json (gateway.auth.token) or OPENCLAW_GATEWAY_TOKEN.',
  ...
  "Tailscale serve/funnel target (port, host:port, or URL)":
    'Tailscale serve/funnel target (port, host:port, or URL)": port, or URL)',
  ...
  "Target looks like a DM user; pass channel:<id> to audit channel permissions.":
    'Target looks like a DM user; pass channel:<id> to audit channel permissions.": <id> to audit channel permissions.',
  ...
  "Thanksgiving: Grateful for stable ports, working DNS, and a bot that reads the logs so nobody has to.":
    'Thanksgiving: Grateful for stable ports, working DNS, and a bot that reads the logs so nobody has to.": Grateful for stable ports, working DNS, and a bot that reads the logs so nobody has to.',
  ...
  "This is the defining action that makes your agent you.": "这是定义您的 Agent 身份的关键操作。",
  ...
  "Timeout for each update step in seconds (default: 1200)":
    'Timeout for each update step in seconds (default: 1200)": 1200)',
  ...
  "Tip: if the gateway is remote, mDNS won’t cross networks; use Wide-Area Bonjour (split DNS) or SSH tunnels.":
    'Tip: if the gateway is remote, mDNS won’t cross networks; use Wide-Area Bonjour (split DNS) or SSH tunnels.": if the gateway is remote, mDNS won’t cross networks; use Wide-Area Bonjour (split DNS) or SSH tunnels.',
  ...
  "Trouble with OAuth? See https://docs.openclaw.ai/start/faq":
    'Trouble with OAuth? See https://docs.openclaw.ai/start/faq": //docs.openclaw.ai/start/faq',
  "Troubleshooting: https://docs.openclaw.ai/troubleshooting":
    'Troubleshooting: https://docs.openclaw.ai/troubleshooting": https://docs.openclaw.ai/troubleshooting',
  ...
  "Unconventional setup: multiple reachable gateways detected. Usually one gateway per network is recommended unless you intentionally run isolated profiles, like a rescue bot (see docs: /gateway#multiple-gateways-same-host).":
    'Unconventional setup: multiple reachable gateways detected. Usually one gateway per network is recommended unless you intentionally run isolated profiles, like a rescue bot (see docs: /gateway#multiple-gateways-same-host).": multiple reachable gateways detected. Usually one gateway per network is recommended unless you intentionally run isolated profiles, like a rescue bot (see docs: /gateway#multiple-gateways-same-host).',
  ...
  "Valentine's Day: Roses are typed, violets are piped—I'll automate the chores so you can spend time with humans.":
    "Valentine's Day: Roses are typed, violets are piped—I'll automate the chores so you can spend time with humans.\": Roses are typed, violets are piped—I'll automate the chores so you can spend time with humans.",
  ...
  "Warm-up: launch agents can take a few seconds. Try again shortly.":
    'Warm-up: launch agents can take a few seconds. Try again shortly.": launch agents can take a few seconds. Try again shortly.',
  "Warnings:": "Warnings:",
  ...
  "Welcome to the command line: where dreams compile and confidence segfaults.":
    'Welcome to the command line: where dreams compile and confidence segfaults.": where dreams compile and confidence segfaults.',
  ...
  "config|config+creds+sessions|full (default: interactive prompt)":
    'config|config+creds+sessions|full (default: interactive prompt)": interactive prompt)',
  ...
  "exec denied: approval required (approval UI not available)":
    'exec denied: approval required (approval UI not available)": approval required (approval UI not available)',
