...
const coreEntries: CoreCliEntry[] = [
  {
    commands: [
      {
        name: "setup",
        description: t("Initialize local config and agent workspace"),
  ...
  },
  {
    commands: [
      {
        name: "onboard",
        description: t("Interactive onboarding wizard for gateway, workspace, and skills"),
        hasSubcommands: false,
      },
    ],
    register: async ({ program }) => {
  ...
  },
  {
    commands: [
      {
        name: "doctor",
        description: t("Health checks + quick fixes for the gateway and channels"),
        hasSubcommands: false,
      },
      {
        name: "dashboard",
        description: t("Open the Control UI with your current token"),
        hasSubcommands: false,
      },
      {
        name: "reset",
        description: t("Reset local config/state (keeps the CLI installed)"),
        hasSubcommands: false,
      },
      {
        name: "uninstall",
        description: t("Uninstall the gateway service + local data (CLI remains)"),
        hasSubcommands: false,
      },
    ],
    register: async ({ program }) => {
  ...
  },
  {
    commands: [
      {
        name: "message",
        description: t("Send, read, and manage messages"),
        hasSubcommands: true,
      },
    ],
  ...
  },
  {
    commands: [
      {
        name: "memory",
        description: t("Search and reindex memory files"),
        hasSubcommands: true,
      },
    ],
    register: async ({ program }) => {
  ...
  },
  {
    commands: [
      {
        name: "agent",
        description: t("Run one agent turn via the Gateway"),
        hasSubcommands: false,
      },
      {
        name: "agents",
        description: t("Manage isolated agents (workspaces, auth, routing)"),
        hasSubcommands: true,
      },
    ],
    register: async ({ program, ctx }) => {
