...
export function registerSecretsCli(program: Command) {
  const secrets = program
    .command("secrets")
    .description(t("Secrets runtime controls"))
    .addHelpText(
      "after",
      () =>
  ...
  addGatewayClientOptions(
    secrets
      .command("reload")
      .description(t("Re-resolve secret references and atomically swap runtime snapshot"))
  ...
  secrets
    .command("audit")
    .description(t("Audit plaintext secrets, unresolved refs, and precedence drift"))
  ...
  secrets
    .command("configure")
    .description(t("Interactive secrets helper (provider setup + SecretRef mapping + preflight)"))
  ...
  secrets
    .command("apply")
    .description(t("Apply a previously generated secrets plan"))
